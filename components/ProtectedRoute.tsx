...
export const DentistRoute = MakeProtectedRoute(["dentist", "admin"]);
export const PatientRoute = MakeProtectedRoute(["patient", "admin"]);
export const DentistOrPatientRoute = MakeProtectedRoute(["dentist", "patient", "admin"]);
export const AllAuthenticatedRoute = MakeProtectedRoute(["admin", "dentist", "patient", "user"]);
